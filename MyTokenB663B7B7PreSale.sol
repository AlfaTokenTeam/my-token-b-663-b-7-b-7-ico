...
import "./MyTokenB663B7B7.sol";

contract MyTokenB663B7B7PreSale {
    MyTokenB663B7B7 public token;
    ...
    function MyTokenB663B7B7PreSale(
        MyTokenB663B7B7 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenB663B7B7(_token);
